...
# Register Usage:			
#################			
# Calculate address of intArr[i] load into $a0
# Calculate offset for i
# address to point to intArr[i]

# Calculate  address of intArr[j] load into $a1
# Calculate offset for j
# address to point to intArr[j]			
#################			
#   int temp = *intPtr1;			
#  *intPtr1 = *intPtr2;			
#   *intPtr2 = temp;			
...
# Register Usage:			
#################			
# Save address charVarToPutInPtr $t0
# Load address $a0
# Set $v0 for syscall, read
# Store the read character at the address in $t0			
#################			
#   cout << prompt;			
